...
public class Estadio {
    ...
    public boolean getDisponibilidade2(){
        for(Reserva rdisponivel: reserva){
            if((rdisponivel.getData().compareTo(d) < 0)) {
                return true;
            } else
    ...
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println("Sistema de Reservas no Estádio " + estadio.getNomeEstadio() + " para a Partida entre " + estadio.getPartida() + " que ocorrerá no dia " + dataJogo + "\n");
        estadio.menu();
    }
}