...
public class Camarote extends Reserva implements ValorIngresso{
    ...
    /**
     ...
     Retorna o tipo do camarote.
     @return o tipo do camarote
     */
    ...
    /**
     Retorna uma representação em string do objeto Camarote, que consiste no valor do ingresso calculado com base na idade da pessoa que está fazendo a reserva e tipo de camarote.
     @return uma string com o valor da reserva para o camarote.
     */
    @Override
