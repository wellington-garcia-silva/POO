/**
 * A classe Camarote representa uma reserva em um tipo específico de um camarote em um evento esportivo ou outra ocasião.
 * Ela estende a classe Reserva.
 * @author Arthur
 */
public class Camarote extends Reserva{
    private String tipo;

    /**
     * Cria uma instância da classe Camarote com o tipo, número da reserva e pessoa que está fazendo
