 ...
 * @author Arthur, Lucas e Wellington
 */
...
public class Estadio {
     ...
     * @param auxCancelamento um auxiliar para fazer o cancelamento da ultima reserva.
     * @param contagemArquibancada a quantidade de reservas feitas na arquibancada.
     * @param contagemCamarote a quantidade de reservas feitas no camarote.
     * @param contagemCadArquibancada a quantidade de reservas cadastradas para arquibancada.
     * @param contagemCadCamarote a quantidade de reservas cadastradas para camarote.
     * @param d a data da reserva.
     */
    ...
    /**
     * Método para salvar o cadastro de reservas em um arquivo.
     */
    ...
    /**
     * Método para carregar o cadastro de reservas salvo em um arquivo.
     */
    ...
    public String titularReserva(){
        Scanner scanner = new Scanner(System.in);
        System.out.print("Digite o numero da reserva para obter informacoes pessoas da reserva: ");
        int numero = scanner.nextInt();
    ...
    /**
     * Método que exibe o número de cadastros realizados.
     */
    ...
    /**
     * Método que exibe o número de reservas feitas.
     */
    ...
    /**
     * Método que calcula o percentual de reservas feitas em relação ao total de assentos cadastrados.
     */
    ...
    public void menuReservas() {
        ...
        while (true) {
            ...
            System.out.println("3 - Cancelar última reserva feita");
    ...
    /**
     * Método que verifica a disponibilidade de uma reserva de acordo com o número.
     * @param numero número da reserva a ser verificada.
     * @return true se a reserva está disponível, false caso contrário.
     */
    ...
    /**
     * Método que verifica a disponibilidade de uma reserva de acordo com a data.
     * @return true se a data atual é anterior à data do evento, false caso contrário.
     */
            ...
            switch (opcao) {
                case 1:
                    ...
                    if (!reservaExisteA) {
                        if (getDisponibilidade(numeroa)) {
                            ...
                            Reserva arquibancada = new Arquibancada(setor, numeroa, p);
                            System.out.printf("O valor a ser pago será de: " + arquibancada.calcularIngresso(idade) + " R$\n");
                ...
                case 2:
                    ...
                    if (numeroc <= getCapacidade() * 0.8 || numeroc > (getCapacidade())) {
                        System.out.println("Número de reserva inválido. Digite um número entre " + ((int) ((getCapacidade() * 0.8))) + " e " + (((getCapacidade()))) + ".");
                        break;
                    }
                    ...
                    if (!reservaExisteC) {
                        if (getDisponibilidade(numeroc) && getDisponibilidade2()) {
                            ...
                            System.out.println("Reserva cadastrada com sucesso!");
                            Reserva camarote = new Camarote(tipo, numeroc, p2);

                            System.out.printf("O valor a ser pago será de: " + camarote.calcularIngresso(idade2) + " R$\n");
    ...
    public void cancelarReserva() {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Confirme o número da cadeira que será cancelada: ");
    ...
    public static void main(String[] args) throws ParseException {
        ...
        String dataJogo = "06/03/2023 16:00:00";
        ...
        System.out.println("\n\nSistema de Reservas para a Partida entre " + estadio.getPartida() + " que ocorrerá no Estádio " + estadio.getNomeEstadio() + " no Dia " + dataJogo + "\n");
        estadio.menu();
    }
}